...
class DBKudeatzailea:
    ...
    def bueltakBete(self, entrenamendua):
        ...
        while(k<bueltaluzera):
            ...
            bueltaEginKM=float(unekoBuelta["distance"])
    ...
    #Entrenamendu motak erakusteko funtzioa (Combobox)
    def motakLortu(self):
    ...
    def bueltakLortu(self, entrenaId):
        ...
        # Bueltak klaseko objektuak sortu
        bueltakLista=[]
    ...
    def ekipamenduakSortu(self):
        ...
        # Ekipamendua klaseko objektuak sortu
        ekipamenduLista=[]
        e=0
        while (e< len(ema)):
            izena=ema[e][0]
    ...
    def neurketakLortu(self, irizpidea, id):
        ...
        if ( ema == None or ema == "None" ):
            #Grafikoan ez da ezer inpriomatukop daturik gordeta ez badaude
            zer=[]
        else:
            balioak = ema[0]
            #[] karaktereak kentzeko eta komatxoekin banatutako balioak banaka hartzeko
