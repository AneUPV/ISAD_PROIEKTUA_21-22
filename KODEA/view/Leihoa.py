...
#FRAME -EN ANTOLAKETA
    ...
    #     LEIHOA ataleko FRAME-ak
    #window-ren barruan:
        #
        # window >> filtraketaframe >>LabelEntry eta botoiak
        #        >> eragiketaframe >> Botoiak
        #        >> main_frame >> TreeView
...
class Leihoa():
    ...
    def __init__(self):
        ...
        #Teklatutik testua jasotzean gertatuko den ekintza
        ...
        #Defektuz GUZTIRA aukeratuta egongo da
